...
const gambarAfter = document.getElementById("imageAfterPoster");
buttonInput.addEventListener("change", () => {
    ...
    if (file && file.type=="image/jpg" || file.type=="image/jpeg" ||file.type=="image/png") {
        ...
        Swal.fire({
            title: `<h4 class="card-title" >Crop Poster Pict</h4> `,
            allowOutsideClick:false,
            html: `<div id="containerKu" style="max-height: 100%; max-width: 100%;margin: auto">
