    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a id="buttonDashboard" class="nav-link" aria-current="page"
                ...
                <li class="nav-item">
                    <a id="buttonPengguna" class="nav-link" data-bs-toggle="collapse" href="#sidebar-pengguna"
                       role="button" aria-expanded="false" aria-controls="sidebar-pengguna">
                        <i class="icon">
                    ...
                    <ul class="sub-nav collapse " id="sidebar-pengguna" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a id="buttonRegisterPengguna" class="nav-link "
                               href="<?= base_url() ?>/admin/penyelenggara/registered">
                                <i class="icon">
                            ...
                            <a id="buttonAddPengguna" class="nav-link "
                               href="<?= base_url() ?>/admin/penyelenggara/new">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                         viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                ...
                <li class="nav-item">
                    <a id="buttonDakwah" class="nav-link" data-bs-toggle="collapse" href="#sidebar-dakwah" role="button"
                       aria-expanded="false" aria-controls="sidebar-dakwah">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
        ...
        <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
            <div class="container-fluid navbar-inner" style="padding-right: 10px;">
                ...
                <ul class="navbar-nav ms-auto align-items-center navbar-list mb-lg-0" style="flex-direction: row;">
                    <div class="btn"
                         style="display: flex;align-items: center;justify-content: center;width: 30px;height: 30px; border-radius: 100%;padding: 0;margin-right: 8px;"
                         id="kuda"></div>
                    <li class="nav-item dropdown">
                        <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button"
                           data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="<?= base_url() . "upload/" . $this->data["adminData"]["profilePict"] ?>"
                                 alt="User-Profile" class="theme-color-default-img img-fluid avatar  avatar-50">
                            <div class="caption ms-3  d-none d-md-block">
                                <h6 class="mb-0 caption-title"><?= esc($this->data["adminData"]["username"]) ?></h6>
                    ...
                    <div class="col-md-12">
                        <div class="flex-wrap d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p>Gunakan panel ini untuk mengakses dan mengelola semua aspek dari dakwah Anda dengan
                                    mudah dan efisien.</p>
                            </div>
                        </div>
                    </div>
