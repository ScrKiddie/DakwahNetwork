<!DOCTYPE html>
<!-- saved from url=(0077)https://templates.iqonic.design/hope-ui/html/dist/dashboard/auth/sign-up.html -->
...
<div class="wrapper">
    <section class="login-content">
        <div class="row m-0 align-items-center bg-white vh-100">
            <div style="background-image: url('<?=base_url()?>img/background-login.png');background-size: 85%" class="col-md-6 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
            </div>
            <div class="col-md-6">
                    ...
                    <div class="col-md-10">
                        <div class="card card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
                            <div class="card-body">
                                <a href="#" class="navbar-brand d-flex align-items-center mb-3">
                                    ...
                                    <a class="navbar-brand d-flex align-items-center mb-3">
                                        ...
                                        <div class="logo-main">
                                            <div class="logo-normal">
                                                <img width="35" src="<?=base_url()?>img/logo.png" alt="">
                                            </div>
                                            <div class="logo-mini">
                                                <img width="20" src="<?=base_url()?>img/logo.png" alt="">
                                            </div>
                                        </div>
                                        <!--logo End-->
                                        ...
                                        <h4 class="logo-title " style="margin-left: 5px">DakNet</h4>
                                    </a>
                                    <?php
                                    ...
                                    if (isset($errors["errors"])){?>
                                        <div style="padding-bottom: 0px" class="alert alert-bottom alert-danger alert-dismissible fade show " role="alert">
                                            <div>Terjadi kesalahan saat mendaftar akun:
                                                <ul>
                                                    <?php
                                ...
                                <p class="text-center">Create your DakNet account.</p>
                                <form enctype="multipart/form-data" action="/user/registering" method="post">
                                    <div class="row">
                                    ...
                                    <p class="mt-3 text-center">
                                        Already have an Account? <a href="/user/login" class="text-underline">Click here to login.</a>
                                    </p>
                                </form>
                            </div>
                        </div>
                ...
                <div class="sign-bg sign-bg-right">
                    <svg width="280" height="230" viewBox="0 0 421 359" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.05">
                            <rect x="-15.0845" y="154.773" width="543" height="77.5714" rx="38.7857" transform="rotate(-45 -15.0845 154.773)" fill="#3A57E8"></rect>
                            <rect x="149.47" y="319.328" width="543" height="77.5714" rx="38.7857" transform="rotate(-45 149.47 319.328)" fill="#3A57E8"></rect>
                            <rect x="203.936" y="99.543" width="310.286" height="77.5714" rx="38.7857" transform="rotate(45 203.936 99.543)" fill="#3A57E8"></rect>
                            <rect x="204.316" y="-229.172" width="543" height="77.5714" rx="38.7857" transform="rotate(45 204.316 -229.172)" fill="#3A57E8"></rect>
                        </g>
                    </svg>
                </div>
            </div>
