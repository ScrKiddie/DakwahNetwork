                                    ...
                                    <td>
                                        <div style="center">
                                            <button id="acceptCRUD" class="btn btn-sm btn-icon text-success"
                                                    onclick="doneButton(<?= $value['id'] ?>,'/admin/dakwah/done')"
                                        ...
                                        <span class="btn-inner">
                                            ...
                                            <a class="btn btn-sm btn-icon text-primary flex-end"
                                               data-bs-toggle="tooltip" href="/admin/dakwah/edit?id=<?= $value['id'] ?>"
                                        ...
                                        <span class="btn-inner">
                                            ...
                                            <button id="deleteCRUD" class="btn btn-sm btn-icon text-danger"
                                                    onclick="deleteButton(<?= $value['id'] ?>,'/admin/dakwah/delete')"
