...
<div class="wrapper">
    <section class="login-content">
        <div class="row m-0 align-items-center bg-white vh-100">
            <div style="background-image: url('<?= base_url() ?>img/background-login.png');background-size: 85%"
                            ...
                            <div class="card-body">
                                <a href="#" class="navbar-brand d-flex align-items-center mb-3">
                                    ...
                                    if (isset($success["success"])) {
                                        ?>
                                        <div class="mb-3 alert alert-bottom alert-success alert-dismissible fade show"
                                             role="alert">
                                    ...
                                    if (isset($errors["errors"])) {
                                        ...
                                        <div style="padding-bottom: 0px"
                                             class="alert alert-bottom alert-danger alert-dismissible fade show "
                                             role="alert">
                                ...
                                <form enctype="multipart/form-data" action="/user/registering" method="post">
                                    ...
                                    <p class="mt-3 text-center">
                                        Already have an Account? <a href="/user/login" class="text-underline">Click here
                                            to login.</a>
                                    </p>
                                </form>
                            </div>
