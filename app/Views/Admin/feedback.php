                                ...
                                <td>
                                    <div style="text-align: center;">
                                        <button id="deleteCRUD" class="btn btn-sm btn-icon text-danger"
                                                onclick="deleteButton(<?= $value['id'] ?>,'/admin/messages/delete')"
