                    ...
                    <div class="table-responsive  my-3">
                        <table id="datatable" class="table table-striped dataTable" data-toggle="data-table" aria-describedby="datatable_info">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="center">
                                        <a class="btn btn-sm btn-icon text-primary flex-end" data-bs-toggle="tooltip" href="#<?=$value['id']?>" aria-label="Edit User" data-bs-original-title="Edit User">
                                        ...
                                        <button class="btn btn-sm btn-icon text-danger" onclick="('apakah anda yakin?')" aria-label="Delete User" data-bs-original-title="Delete User">
                                        <span class="btn-inner">
