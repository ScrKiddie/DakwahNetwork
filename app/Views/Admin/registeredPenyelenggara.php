                        ...
                        <table id="datatable" class="table table-striped dataTable" data-toggle="data-table"
                            ...
                            <tr>
                                <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable" rowspan="1"
                                    ...
                                    aria-label="Name: activate to sort column descending" style="width: 176.65px;">Email
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                                    aria-label="Position: activate to sort column ascending" style="width: 278.475px;">
                                    Username
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                                    aria-label="Age: activate to sort column ascending" style="width: 45.475px;">Nama
                                    Lembaga
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                                    aria-label="Start date: activate to sort column ascending" style="width: 113.5px;">
                                    Alamat
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                                    aria-label="Salary: activate to sort column ascending" style="width: 106.675px;">No
                                    Telp
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                                    ...
                                    <td>
                                        <div style="center">
                                            <button id="acceptCRUD" class="btn btn-sm btn-icon text-success"
                                                    onclick="acceptButton(<?= $value['id'] ?>)" aria-label="Delete User"
                                        ...
                                        <span class="btn-inner">
                                            ...
                                            <button id="deleteCRUD" class="btn btn-sm btn-icon text-danger"
                                                    onclick="deleteButton(<?= $value['id'] ?>,'/admin/penyelenggara/delete')"
