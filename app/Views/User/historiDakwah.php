...
?>
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between" style="align-items: center">
                    ...
                    <a href="#" id="excel" class="text-center btn btn-primary mt-lg-0 mt-md-0 mt-3" style="margin-top: 0px !important; padding: 3px 8px 3px 5px;display: flex;justify-content: center;align-items: center">
                        <i class="btn-inner">
                            <svg class="icon-3" width="3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="table-responsive  my-3">
                        <table id="datatable" class="table table-striped dataTable" data-toggle="data-table" aria-describedby="datatable_info">
                            ...
                            <tr>
                                ...
                                <th class="sorting" tabindex="1" aria-controls="datatable" rowspan="1" colspan="1"  style="width: 278.475px;">Judul</th>
                                <th class="sorting" tabindex="2" aria-controls="datatable" rowspan="1" colspan="1" style="width: 45.475px;">Tema</th>
                                <th class="sorting" tabindex="3" aria-controls="datatable" rowspan="1" colspan="1"  style="width: 113.5px;">Pendakwah</th>
                                <th class="sorting" tabindex="4" aria-controls="datatable" rowspan="1" colspan="1"  style="width: 106.675px;">Lokasi</th>
                                <th class="sorting" tabindex="5" aria-controls="datatable" rowspan="1" colspan="1"  style="width: 106.675px;">Waktu Mulai</th>

                                <th class="sorting" tabindex="6" aria-controls="datatable" rowspan="1" colspan="1" style="width: 106.675px;">Durasi</th>
            ...
            margin-bottom: 7px;"  id="selengkapnyake<?=$count?>" ><?=esc($value['deskripsi'])?></p>
                                    ...
                                    <td>
                                        <div style="center">
                                            ...
                                            <button id="deleteCRUD" class="btn btn-sm btn-icon text-danger" onclick="deleteButton(<?=$value['id']?>,'/user/dakwah/delete')" aria-label="Delete User" data-bs-original-title="Delete User">
    ...
    <script defer src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.17.3/xlsx.full.min.js"></script>
