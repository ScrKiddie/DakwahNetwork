            ...
            <form method="post" action="/admin/penyelenggara/add" enctype="multipart/form-data">
                <div class="row" style="padding-left: 10px;padding-right: 10px">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input name="username" autocomplete="off" type="text" class="form-control" id="validationDefault02" >
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="validationCustomUsername" class="form-label">Username</label>
                        <input name="password" autocomplete="off" type="text" class="form-control" id="validationCustomUsername" aria-label="Username" aria-describedby="basic-addon1" >
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label" for="validationDefault03">Alamat Lembaga</label>
                        <input  name="namaLembaga" autocomplete="off" type="text" class="form-control" id="validationDefault03" >
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label" for="validationDefault04">Password</label>
                        <input name="alamatLembaga" autocomplete="off" type="password" class="form-control" id="exampleInputPassword3">
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <button style="padding: 0;margin: 0;width: fit-content;height: fit-content" class="form-control" type="button" onclick="klikInput()">
                            <img id="imageAfter" style="width: 400px;height: 400px; padding: 0px" src="<?=base_url()."/img/add-image.png"?>">
                        </button>
                        ...
                        <div class="">
                            <a id="triggerButton" href="#" class=" text-center btn btn-primary btn-icon mt-lg-0 mt-md-0 mt-3" data-bs-toggle="modal" data-bs-target="#staticBackdrop"style="visibility: hidden;display: none">
                            </a>
                            <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" style="display: none;" aria-hidden="true">
                                <div class="modal-dialog card" >
                                    <div id="modalgwe" class="modal-content dark">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="staticBackdropLabel">Crop Picture</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body" style="display: flex;align-items: center;justify-content: center;flex-direction: column">
                                                <img  id="image" src="" style="max-width: 100% !important;max-height: 100vh !important;">

                                        </div>
                                        <div class="modal-footer">
                                            <div class="text-start"style="margin-top: 10px;">
                                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal" >Cancel</button>
                                                <button id="saveCrop" style="margin-right: 7px" type="button" class="btn btn-primary"data-bs-dismiss="modal">Save</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
