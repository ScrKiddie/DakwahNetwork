            ...
            <form method="post" action="/admin/profile/save" enctype="multipart/form-data">
                <div class="col" style="padding-left: 10px;padding-right: 10px">
                    <div class="col-md-6 mb-3">
                        ...
                        <input name="username" value="<?= $this->data["adminData"]["username"] ?>" autocomplete="off"
                               type="text" class="form-control" id="validationCustomUsername" aria-label="Username"
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <button style=" padding: 0;margin: 0;width: fit-content;height: fit-content"
                            ...
                            <img id="imageAfter" style="border-radius: 0.25rem;width: 100%;height: 100%; padding: 0px"
                                 src="<?= base_url() . "/upload/" . $this->data["adminData"]["profilePict"] ?>">
                        </button>
