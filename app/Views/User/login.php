                            ...
                            <div class="card-body">
                                ...
                                if (isset($errors["errors"])){?>
                                    <div style="padding-bottom: 0px" class="alert alert-bottom alert-danger alert-dismissible fade show " role="alert">
                                        <div>Terjadi kesalahan saat login:
                                            <ul>
                                                <?php
                                ...
                                <form enctype="multipart/form-data" method="post" action="/user/auth">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label for="username" class="form-label">Username / Email</label>
                                                <input type="text" class="form-control" id="username" name="username" aria-describedby="email" placeholder=" ">
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                    ...
                                    <p class="mt-3 text-center">
                                        Don’t have an account? <a href="/user/register" class="text-underline">Click here to register.</a>
                                    </p>
                                </form>
                            </div>
                        </div>
